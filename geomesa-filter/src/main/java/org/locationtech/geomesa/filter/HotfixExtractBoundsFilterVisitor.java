 ...
 * @source $URL$
 */
public class HotfixExtractBoundsFilterVisitor extends NullFilterVisitor {
    static public NullFilterVisitor BOUNDS_VISITOR = new HotfixExtractBoundsFilterVisitor();
     ...
     */
    protected HotfixExtractBoundsFilterVisitor(){
    }

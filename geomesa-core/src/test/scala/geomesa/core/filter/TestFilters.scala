...
object TestFilters {
  ...
  val exampleGeomFilters =
    Seq(
      "INTERSECTS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '0000-01-01T00:00:00.000Z' AND '9999-12-31T23:59:59.000Z')",
      "INTERSECTS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '2010-06-30T20:00:00.000-04:00' AND '2010-07-30T20:00:00.000-04:00')",
      "INTERSECTS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
      "OVERLAPS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '0000-01-01T00:00:00.000Z' AND '9999-12-31T23:59:59.000Z')",
      "OVERLAPS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '2010-06-30T20:00:00.000-04:00' AND '2010-07-30T20:00:00.000-04:00')",
      "OVERLAPS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
      "WITHIN(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '0000-01-01T00:00:00.000Z' AND '9999-12-31T23:59:59.000Z')",
      "WITHIN(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '2010-06-30T20:00:00.000-04:00' AND '2010-07-30T20:00:00.000-04:00')",
      "WITHIN(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
      "CONTAINS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '0000-01-01T00:00:00.000Z' AND '9999-12-31T23:59:59.000Z')",
      "CONTAINS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '2010-06-30T20:00:00.000-04:00' AND '2010-07-30T20:00:00.000-04:00')",
      "CONTAINS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
      "TOUCHES(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '0000-01-01T00:00:00.000Z' AND '9999-12-31T23:59:59.000Z')",
      "TOUCHES(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '2010-06-30T20:00:00.000-04:00' AND '2010-07-30T20:00:00.000-04:00')",
      "TOUCHES(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
      "EQUALS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '0000-01-01T00:00:00.000Z' AND '9999-12-31T23:59:59.000Z')",
      "EQUALS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '2010-06-30T20:00:00.000-04:00' AND '2010-07-30T20:00:00.000-04:00')",
      "EQUALS(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
      "DISJOINT(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '0000-01-01T00:00:00.000Z' AND '9999-12-31T23:59:59.000Z')",
      "DISJOINT(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '2010-06-30T20:00:00.000-04:00' AND '2010-07-30T20:00:00.000-04:00')",
      "DISJOINT(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23)))",
      "CROSSES(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '0000-01-01T00:00:00.000Z' AND '9999-12-31T23:59:59.000Z')",
      "CROSSES(geom, POLYGON ((45 23, 48 23, 48 27, 45 27, 45 23))) AND (dtg between '2010-06-30T20:00:00.000-04:00' AND '2010-07-30T20:00:00.000-04:00')",

...
class GeoMesaParamTest extends Specification with LazyLogging {
  ...
  "GeoMesaParam" should {
    ...
    "lookup deprecated values" in {
      new GeoMesaParam[String]("foo", deprecated = Seq("notfoo")).lookup(Map("foo" -> "bar")) mustEqual "bar"
      new GeoMesaParam[String]("foo", deprecated = Seq("notfoo")).lookup(Map("notfoo" -> "bar")) mustEqual "bar"
      new GeoMesaParam[String]("foo", required = true, deprecated = Seq("notfoo")).lookup(Map("foo" -> "bar")) mustEqual "bar"
      new GeoMesaParam[String]("foo", required = true, deprecated = Seq("notfoo")).lookup(Map("notfoo" -> "bar")) mustEqual "bar"
    }
    "look up system properties" in {
      val prop = SystemProperty("params.foo.bar")
      prop.threadLocalValue.set("baz")
      new GeoMesaParam[String]("foo", systemProperty = Some((prop, (p) => p))).lookup(Map("foo" -> "bar")) mustEqual "bar"
      new GeoMesaParam[String]("foo", systemProperty = Some((prop, (p) => p))).lookup(Map.empty[String, String]) mustEqual "baz"
      prop.threadLocalValue.set("2")
      new GeoMesaParam[Integer]("foo", systemProperty = Some((prop, (p) => p.toInt))).lookup(Map("foo" -> Int.box(1))) mustEqual 1
      new GeoMesaParam[Integer]("foo", systemProperty = Some((prop, (p) => p.toInt))).lookup(Map.empty[String, String]) mustEqual 2
      prop.threadLocalValue.set("true")
      new GeoMesaParam[java.lang.Boolean]("foo", systemProperty = Some((prop, (p) => p.toBoolean))).lookup(Map("foo" -> Boolean.box(false))) mustEqual false
      new GeoMesaParam[java.lang.Boolean]("foo", systemProperty = Some((prop, (p) => p.toBoolean))).lookup(Map.empty[String, String]) mustEqual true
    }
    "not accept system properties for required parameters" in {
      val prop = SystemProperty("params.foo.bar")
      prop.threadLocalValue.set("baz")
      new GeoMesaParam[String]("foo", required = true, systemProperty = Some((prop, (p) => p))).lookup(Map("foo" -> "bar")) mustEqual "bar"
      new GeoMesaParam[String]("foo", required = true, systemProperty = Some((prop, (p) => p))).lookup(Map.empty[String, String]) must throwAn[IOException]
      prop.threadLocalValue.set("2")
      new GeoMesaParam[Integer]("foo", required = true, systemProperty = Some((prop, (p) => p.toInt))).lookup(Map("foo" -> Int.box(1))) mustEqual 1
      new GeoMesaParam[Integer]("foo", required = true, systemProperty = Some((prop, (p) => p.toInt))).lookup(Map.empty[String, String]) must throwAn[IOException]
      prop.threadLocalValue.set("true")
      new GeoMesaParam[java.lang.Boolean]("foo", required = true, systemProperty = Some((prop, (p) => p.toBoolean))).lookup(Map("foo" -> Boolean.box(false))) mustEqual false
      new GeoMesaParam[java.lang.Boolean]("foo", required = true, systemProperty = Some((prop, (p) => p.toBoolean))).lookup(Map.empty[String, String]) must throwAn[IOException]
    }
    "prioritize system properties over default values" in {
      val prop = SystemProperty("params.foo.bar")
      prop.threadLocalValue.set("baz")
      new GeoMesaParam[String]("foo", default = "wuz", systemProperty = Some((prop, (p) => p))).lookup(Map("foo" -> "bar")) mustEqual "bar"
      new GeoMesaParam[String]("foo", default = "wuz", systemProperty = Some((prop, (p) => p))).lookup(Map.empty[String, String]) mustEqual "baz"
      prop.threadLocalValue.remove()
      new GeoMesaParam[String]("foo", default = "wuz", systemProperty = Some((prop, (p) => p))).lookup(Map.empty[String, String]) mustEqual "wuz"
    }
    "require system properties to have a common default" in {
      new GeoMesaParam[String]("foo", systemProperty = Some((SystemProperty("params.foo.bar", "baz"), (p) => p))) must throwAn[AssertionError]
      new GeoMesaParam[String]("foo", default = "bar", systemProperty = Some((SystemProperty("params.foo.bar", "baz"), (p) => p))) must throwAn[AssertionError]
      new GeoMesaParam[String]("foo", default = "bar", systemProperty = Some((SystemProperty("params.foo.bar", "bar"), (p) => p))) must not(throwAn[AssertionError])
      new GeoMesaParam[Integer]("foo", systemProperty = Some((SystemProperty("params.foo.bar", "2"), (p) => p.toInt))) must throwAn[AssertionError]
      new GeoMesaParam[Integer]("foo", default = 1, systemProperty = Some((SystemProperty("params.foo.bar", "2"), (p) => p.toInt))) must throwAn[AssertionError]

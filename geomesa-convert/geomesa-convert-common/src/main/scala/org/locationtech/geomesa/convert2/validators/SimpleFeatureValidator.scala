...
object SimpleFeatureValidator extends LazyLogging {
   ...
   * @return
   */
  def apply(sft: SimpleFeatureType, names: Seq[String], tags: Tags = Tags.empty()): SimpleFeatureValidator = {
  ...
  /**
    ...
    */
  private class CompositeValidator(validators: Seq[SimpleFeatureValidator]) extends SimpleFeatureValidator {

...
import org.locationtech.geomesa.tools.common.DelimitedExport
...
class DelimitedExportImportTest extends Specification {
  ...
  def export(features: SimpleFeatureCollection, format: Formats): String = {
    val writer = new StringWriter()
    val export = new DelimitedExport(writer, format)

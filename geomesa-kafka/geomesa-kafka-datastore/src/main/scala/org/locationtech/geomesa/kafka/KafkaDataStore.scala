...
class KafkaDataStoreFactory extends DataStoreFactorySpi {
  ...
  override def getParametersInfo: Array[Param] =
    Array(KAFKA_BROKER_PARAM, ZOOKEEPERS_PARAM, ZK_PATH, EXPIRATION_PERIOD, CLEANUP_LIVE_CACHE, CACHE_CLEANUP_PERIOD, TOPIC_PARTITIONS, TOPIC_REPLICATION, NAMESPACE_PARAM, COLLECT_QUERY_STAT)

...
/**
  ...
  */
case class AttributeScheme(attribute: String, index: Int, binding: Class[_], defaultPartition: String, allowedValues: Seq[String])
...
object AttributeScheme {
  ...
  object AttributePartitionSchemeFactory extends PartitionSchemeFactory {

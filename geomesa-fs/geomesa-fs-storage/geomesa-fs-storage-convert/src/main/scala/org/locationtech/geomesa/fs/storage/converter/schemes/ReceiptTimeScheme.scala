...
import org.locationtech.geomesa.fs.storage.converter.schemes.ReceiptTimeScheme.BufferingFilterVisitor
...
object ReceiptTimeScheme {
  ...
  object ReceiptTimePartitionSchemeFactory extends PartitionSchemeFactory {

...
import org.locationtech.geomesa.fs.storage.core.{FileSystemContext, Metadata, Partition, StorageCatalog}
...
//      try {
//        val conf = Map(StorageCatalog.MetadataTypeConfig -> "file")

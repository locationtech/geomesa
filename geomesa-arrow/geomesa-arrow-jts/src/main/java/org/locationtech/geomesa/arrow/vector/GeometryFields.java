...
public class GeometryFields {
  ...
  public static List<Field> XY_FLOAT = Collections.singletonList(
      new Field(BaseRepeatedValueVector.DATA_VECTOR_NAME, true, GeometryFields.FLOAT_TYPE, null));

  /**
   * Single double vector, appropriate for storing Points
   */
  public static List<Field> XY_DOUBLE = Collections.singletonList(
      new Field(BaseRepeatedValueVector.DATA_VECTOR_NAME, true, GeometryFields.DOUBLE_TYPE, null));
  ...
  public static List<Field> XY_FLOAT_LIST = Collections.singletonList(
      new Field(BaseRepeatedValueVector.DATA_VECTOR_NAME, true, new ArrowType.FixedSizeList(2), XY_FLOAT));
  ...
  public static List<Field> XY_DOUBLE_LIST = Collections.singletonList(
      new Field(BaseRepeatedValueVector.DATA_VECTOR_NAME, true, new ArrowType.FixedSizeList(2), XY_DOUBLE));
  ...
  public static List<Field> XY_FLOAT_LIST_2 = Collections.singletonList(
      new Field(BaseRepeatedValueVector.DATA_VECTOR_NAME, true, ArrowType.List.INSTANCE, XY_FLOAT_LIST));
  ...
  public static List<Field> XY_DOUBLE_LIST_2 = Collections.singletonList(
      new Field(BaseRepeatedValueVector.DATA_VECTOR_NAME, true, ArrowType.List.INSTANCE, XY_DOUBLE_LIST));
  ...
  public static List<Field> XY_FLOAT_LIST_3 = Collections.singletonList(
      new Field(BaseRepeatedValueVector.DATA_VECTOR_NAME, true, ArrowType.List.INSTANCE, XY_FLOAT_LIST_2));
  ...
  public static List<Field> XY_DOUBLE_LIST_3 = Collections.singletonList(
      new Field(BaseRepeatedValueVector.DATA_VECTOR_NAME, true, ArrowType.List.INSTANCE, XY_DOUBLE_LIST_2));
}

...
public class MultiPointVector implements GeometryVector<MultiPoint> {
  ...
  public static class MultiPointWriter extends BaseGeometryWriter<MultiPoint> implements GeometryWriter<MultiPoint> {
  ...
  public static class MultiPointReader extends BaseGeometryReader<MultiPoint> implements GeometryReader<MultiPoint> {
    ...
    protected MultiPoint readGeometry(int index) {
      List<Double> xs = (List<Double>) xAccessor.getObject(index);
      List<Double> ys = (List<Double>) yAccessor.getObject(index);
      if (xs.size() != ys.size()) {

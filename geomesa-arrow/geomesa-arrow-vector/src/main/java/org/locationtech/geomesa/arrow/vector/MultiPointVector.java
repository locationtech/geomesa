...
import org.locationtech.geomesa.arrow.vector.reader.MultiPointReader;
import org.locationtech.geomesa.arrow.vector.writer.MultiPointWriter;
...
public class MultiPointVector implements GeometryVector<MultiPoint> {
  ...
  public MultiPointVector(NullableMapVector vector) {
    ...
    this.writer = new MultiPointWriter(new NullableMapWriter(vector), X_FIELD, Y_FIELD);
    this.reader = new MultiPointReader(vector, X_FIELD, Y_FIELD);
  }

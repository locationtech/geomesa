...
.. |release_tarball_kafka08| replace:: %(url_locationtech_release)s/geomesa-kafka-08-dist_2.11/%(release_last)s/geomesa-kafka-08-dist_2.11-%(release_last)s-bin.tar.gz

.. |release_tarball_kafka09| replace:: %(url_locationtech_release)s/geomesa-kafka-09-dist_2.11/%(release_last)s/geomesa-kafka-09-dist_2.11-%(release_last)s-bin.tar.gz

.. |release_tarball_kafka10| replace:: %(url_locationtech_release)s/geomesa-kafka-10-dist_2.11/%(release_last)s/geomesa-kafka-10-dist_2.11-%(release_last)s-bin.tar.gz

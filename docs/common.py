...
.. |release_tarball| replace:: https://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-dist/%(release)s/geomesa-dist-%(release)s-bin.tar.gz
...
.. |release_1_1_tarball| replace::  https://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-assemble/%(release_1_1)s/geomesa-assemble-%(release_1_1)s-bin.tar.gz

.. |release_1_1_source_tarball| replace:: https://github.com/locationtech/geomesa/archive/geomesa-%(release_1_1)s.tar.gz
...
.. |accumulo_version| replace:: 1.5 or 1.6

.. |hadoop_version| replace:: 2.2 or better

.. |zookeeper_version| replace:: 3.4.5 or better

.. |kafka_version| replace:: 0.8.2

""" % {"release": release, "release_1_1": release_1_1, "version_devel": version_devel}

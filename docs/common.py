...
# RST appended to every file. Used for global substitutions.
# note that currently we handle this in conf.py to support substitutions in code blocks.
rst_epilog = """
"""
...
# documentation.
html_theme_options = {
  'canonical_url': 'https://www.geomesa.org/documentation/stable/',

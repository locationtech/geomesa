...
.. |release_tarball| replace:: http://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-dist/%(release)s/geomesa-%(release)s-bin.tar.gz
...
.. |release_1_1_tarball| replace::  http://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-assemble/%(release_1_1)s/geomesa-assemble-%(release_1_1)s-bin.tar.gz
...
""" % {"release": release, "release_1_1": "1.1.0.rc-7"}

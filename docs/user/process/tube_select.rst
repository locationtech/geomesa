...
The ``TubeSelectProcess`` performs a correlated search across time and space. For more information on the ``TubeSelectProcess``
and how to use it, see the `tube select tutorial <https://www.geomesa.org/documentation/tutorials/geomesa-tubeselect.html>`__.
Tube select accepts the following parameters:
...
The following XML is an example of the TubeSelectProcess:
            ...
            <wps:Execute version="1.0.0" service="WPS">
              ...
              <wps:DataInputs>
                ...
                <wps:Input>
                  ...
                  <wps:Data>
                    <wps:ComplexData mimeType="text/plain; subtype=cql"><![CDATA[CabId = 367380880]]></wps:ComplexData>
                  </wps:Data>
                </wps:Input>
              </wps:DataInputs>
              <wps:ResponseForm>
            ...
            <wps:Execute version="1.0.0" service="WPS">
              ...
              <wps:DataInputs>
                ...
                <wps:Input>
                  <ows:Identifier>filter</ows:Identifier>
                  <wps:Data>
                    <wps:ComplexData mimeType="text/plain; subtype=cql"><![CDATA[CabId = 366990520]]></wps:ComplexData>
                  </wps:Data>
                </wps:Input>
              </wps:DataInputs>
              <wps:ResponseForm>
...
Assuming the above XML is in a file named ``TubeSelectProcess_wps.xml``, it can be invoked with the following ``curl`` to
GeoServer:

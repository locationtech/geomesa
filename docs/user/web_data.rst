...
+------------------------------------------------------------+------------+
| geomesa-accumulo-datastore_2.11-$VERSION.jar               | 3059818    |
+------------------------------------------------------------+------------+
| geomesa-accumulo-gs-plugin_2.11-$VERSION.jar               | 10127      |
+------------------------------------------------------------+------------+
| geomesa-accumulo-raster_2.11-$VERSION.jar                  | 198232     |
+------------------------------------------------------------+------------+
| geomesa-feature-all_2.11-$VERSION.jar                      | 12852      |
+------------------------------------------------------------+------------+
| geomesa-feature-avro_2.11-$VERSION.jar                     | 225008     |
+------------------------------------------------------------+------------+
| geomesa-feature-common_2.11-$VERSION.jar                   | 117385     |
+------------------------------------------------------------+------------+
| geomesa-feature-kryo_2.11-$VERSION.jar                     | 178062     |
+------------------------------------------------------------+------------+
| geomesa-feature-nio_2.11-$VERSION.jar                      | 178062     |
+------------------------------------------------------------+------------+
| geomesa-filter_2.11-$VERSION.jar                           | 313285     |
+------------------------------------------------------------+------------+
| geomesa-index-api_2.11-$VERSION.jar                        | 268719     |
+------------------------------------------------------------+------------+
| geomesa-logger_2.11-$VERSION.jar                           | 4213       |
+------------------------------------------------------------+------------+
| geomesa-security_2.11-$VERSION.jar                         | 41549      |
+------------------------------------------------------------+------------+
| geomesa-utils_2.11-$VERSION.jar                            | 1411815    |
+------------------------------------------------------------+------------+
| geomesa-web-core_2.11-$VERSION.jar                         | 65319      |
+------------------------------------------------------------+------------+
| geomesa-web-data_2.11-$VERSION.jar                         | 88438      |
+------------------------------------------------------------+------------+
| geomesa-z3_2.11-$VERSION.jar                               | 107225     |
+------------------------------------------------------------+------------+

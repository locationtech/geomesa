...
.. code-block:: bash
    ...
    $ wget http://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-fs-dist_2.11/$VERSION/geomesa-fs-dist_2.11-$VERSION-bin.tar.gz

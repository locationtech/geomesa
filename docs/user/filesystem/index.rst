...
and column-based encodings for efficient OLAP queries. GeoMesa FSDS can run on local disk or on distributed object stores
such as Amazon S3. This enables users to realize cost savings through the utilization of elastic compute resources instead

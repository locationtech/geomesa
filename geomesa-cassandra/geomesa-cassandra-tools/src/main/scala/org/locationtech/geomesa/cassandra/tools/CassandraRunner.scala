...
import org.locationtech.geomesa.cassandra.tools.export.{CassandraFileExportCommand, CassandraLeafletExportCommand}
...
object CassandraRunner extends Runner {
  ...
  override def createCommands(jc: JCommander): Seq[Command] = Seq(
    ...
    new CassandraFileExportCommand,
    new CassandraLeafletExportCommand,

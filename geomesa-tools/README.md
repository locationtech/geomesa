...
#### csv
 for ingesting csv files containing WKT geometries in the last column width the following caveat: CSV files must surround values with double quotation marks, e.g.:
 `"37266103","2013-07-17","POINT(0.0 0.0)"`.

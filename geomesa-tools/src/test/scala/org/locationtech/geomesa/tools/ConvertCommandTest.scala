...
//
//
//  "Convert Command should convert csv -> csv" in {
//    val params = new ConvertParameters
//    params.files.add(testCSVFile.toString)
//    params.config = testConf
//    params.spec = testConf
//    params.outputFormat = "csv"
//    params.file = File.createTempFile("convertTest", ".csv")
//    val sft = CLArgResolver.getSft(params.spec)
//
//    "get a Converter" in {
//      val converter = ConvertCommand.getConverter(params, sft)
...
//      val fc = new DefaultFeatureCollection(sft.getTypeName, sft)
//      val converter = ConvertCommand.getConverter(params, sft)
//      ConvertCommand.convertFile(params.files.get(0), converter, params, fc)
//      fc.size() must beEqualTo(3)
//    }
//
//    "export data" in {
...
//  }
//
//  val jsonRes = "{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[-100.2365,23]},\"properties\":{\"fid\":23623,\"name\":\"Harry\",\"age\":20,\"lastseen\":\"2015-05-06T00:00:00.000+0000\",\"friends\":\"[Will, Mark, Suzan]\",\"talents\":\"{patronus=10, expelliarmus=9}\"},\"id\":\"23623\"},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[40.232,-53.2356]},\"properties\":{\"fid\":26236,\"name\":\"Hermione\",\"age\":25,\"lastseen\":\"2015-06-07T00:00:00.000+0000\",\"friends\":\"[Edward, Bill, Harry]\",\"talents\":\"{accio=10}\"},\"id\":\"26236\"},{\"type\":\"Feature\",\"geometry\":{\"type\":\"Point\",\"coordinates\":[3,-62.23]},\"properties\":{\"fid\":3233,\"name\":\"Severus\",\"age\":30,\"lastseen\":\"2015-10-23T00:00:00.000+0000\",\"friends\":\"[Tom, Riddle, Voldemort]\",\"talents\":\"{potions=10}\"},\"id\":\"3233\"}]}"
//
//  "Convert Command should convert csv -> json" in {
//    val params = new ConvertParameters
//    params.files.add(testCSVFile.toString)
//    params.config = testConf
//    params.spec = testConf
//    params.outputFormat = "json"
//    params.file = File.createTempFile("convertTest", ".json")
//    val sft = CLArgResolver.getSft(params.spec)
//
//    // Would be redundant to duplicate other tests
//
//    "export data" in {
//      val fc = new DefaultFeatureCollection(sft.getTypeName, sft)
//      val converter = ConvertCommand.getConverter(params, sft)
...
//      exporter.export(fc)
//      val res = Source.fromFile(params.file)
//      res.getLines.length mustEqual 1
//      res mustEqual jsonRes
//    }
//
//    FileUtils.deleteQuietly(params.file)
//  }

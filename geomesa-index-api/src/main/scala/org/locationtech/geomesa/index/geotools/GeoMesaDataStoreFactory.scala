...
object GeoMesaDataStoreFactory {
  ...
  val QueryThreadsParam  = new GeoMesaParam[Integer]("geomesa.query.threads", "The number of threads to use per query", false, 8, deprecatedKeys = Seq("queryThreads", "accumulo.queryThreads"))

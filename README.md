...
**Current release: [5.2.1](https://github.com/locationtech/geomesa/releases/tag/geomesa-5.2.1)**

  &nbsp;&nbsp;&nbsp;&nbsp;
  [**Accumulo**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.1/geomesa-accumulo_2.12-5.2.1-bin.tar.gz) |
  [**HBase**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.1/geomesa-hbase_2.12-5.2.1-bin.tar.gz) |
  [**Cassandra**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.1/geomesa-cassandra_2.12-5.2.1-bin.tar.gz) |
  [**Kafka**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.1/geomesa-kafka_2.12-5.2.1-bin.tar.gz) |
  [**Redis**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.1/geomesa-redis_2.12-5.2.1-bin.tar.gz) |
  [**FileSystem**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.1/geomesa-fs_2.12-5.2.1-bin.tar.gz) |
  [**PostGIS**](https://github.com/locationtech/geomesa/releases/download/geomesa-5.2.1/geomesa-gt_2.12-5.2.1-bin.tar.gz)
...
```bash
$ gpg2 --verify geomesa-accumulo_2.12-5.2.1-bin.tar.gz.asc geomesa-accumulo_2.12-5.2.1-bin.tar.gz
```
...
libraryDependencies ++= Seq(
  "org.locationtech.geomesa" %% "geomesa-utils" % "5.2.1"
)
```

## Building from Source

**Development version: 5.2.2-SNAPSHOT**

...
**Current release: 2.2.0**
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;
  [**HBase**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.2.0/geomesa-hbase_2.11-2.2.0-bin.tar.gz) |
  [**Accumulo**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.2.0/geomesa-accumulo_2.11-2.2.0-bin.tar.gz) |
  [**Cassandra**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.2.0/geomesa-cassandra_2.11-2.2.0-bin.tar.gz) |
  [**Kafka**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.2.0/geomesa-kafka_2.11-2.2.0-bin.tar.gz) |
  [**FileSystem**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.2.0/geomesa-fs_2.11-2.2.0-bin.tar.gz) |
  [**Bigtable**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.2.0/geomesa-bigtable_2.11-2.2.0-bin.tar.gz) |
  [**Source**](https://github.com/locationtech/geomesa/archive/geomesa_2.11-2.2.0.tar.gz) |
  [**CheckSums**](https://github.com/locationtech/geomesa/releases/geomesa_2.11-2.2.0)
...
```bash
$ gpg2 --verify geomesa-accumulo_2.11-2.2.0-bin.tar.gz.asc geomesa-accumulo_2.11-2.2.0-bin.tar.gz
```
...
libraryDependencies ++= Seq(
  "org.locationtech.geomesa" %% "geomesa-utils" % "2.2.0",
  ...
)
```

...
**Current release: 2.1.3**
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;
  [**HBase**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.1.3/geomesa-hbase_2.11-2.1.3-bin.tar.gz) |
  [**Accumulo**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.1.3/geomesa-accumulo_2.11-2.1.3-bin.tar.gz) |
  [**Cassandra**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.1.3/geomesa-cassandra_2.11-2.1.3-bin.tar.gz) |
  [**Kafka**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.1.3/geomesa-kafka_2.11-2.1.3-bin.tar.gz) |
  [**FileSystem**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-2.1.3/geomesa-fs_2.11-2.1.3-bin.tar.gz) |
  [**Source**](https://github.com/locationtech/geomesa/archive/geomesa_2.11-2.1.3.tar.gz) |
  [**CheckSums**](https://github.com/locationtech/geomesa/releases/geomesa_2.11-2.1.3)

**Development version: 2.1.4-SNAPSHOT** &nbsp;
...
```bash
$ gpg2 --verify geomesa-accumulo_2.11-2.1.3-bin.tar.gz.asc geomesa-accumulo_2.11-2.1.3-bin.tar.gz
```
...
libraryDependencies ++= Seq(
  "org.locationtech.geomesa" %% "geomesa-utils" % "2.1.3",
  ...
)
```

...
**Current release: [3.1.1](https://github.com/locationtech/geomesa/releases/tag/geomesa_2.11-3.1.1)**

  &nbsp;&nbsp;&nbsp;&nbsp;
  [**HBase**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-3.1.1/geomesa-hbase_2.11-3.1.1-bin.tar.gz) |
  [**Accumulo**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-3.1.1/geomesa-accumulo_2.11-3.1.1-bin.tar.gz) |
  [**Cassandra**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-3.1.1/geomesa-cassandra_2.11-3.1.1-bin.tar.gz) |
  [**Kafka**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-3.1.1/geomesa-kafka_2.11-3.1.1-bin.tar.gz) |
  [**Redis**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-3.1.1/geomesa-redis_2.11-3.1.1-bin.tar.gz) |
  [**FileSystem**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-3.1.1/geomesa-fs_2.11-3.1.1-bin.tar.gz) |
  [**Bigtable**](https://github.com/locationtech/geomesa/releases/download/geomesa_2.11-3.1.1/geomesa-bigtable_2.11-3.1.1-bin.tar.gz)
...
```bash
$ gpg2 --verify geomesa-accumulo_2.11-3.1.1-bin.tar.gz.asc geomesa-accumulo_2.11-3.1.1-bin.tar.gz
```
...
libraryDependencies ++= Seq(
  "org.locationtech.geomesa" %% "geomesa-utils" % "3.1.1"
)
```

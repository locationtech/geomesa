...
**Current release: 1.3.0**
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;
  [**Accumulo**](https://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-accumulo-dist_2.11/1.3.0/geomesa-accumulo-dist_2.11-1.3.0-bin.tar.gz) |
  [**Kafka 0.8**](https://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-kafka-08-dist_2.11/1.3.0/geomesa-kafka-08-dist_2.11-1.3.0-bin.tar.gz) |
  [**Kafka 0.9**](https://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-kafka-09-dist_2.11/1.3.0/geomesa-kafka-09-dist_2.11-1.3.0-bin.tar.gz) |
  [**Kafka 0.10**](https://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-kafka-10-dist_2.11/1.3.0/geomesa-kafka-10-dist_2.11-1.3.0-bin.tar.gz) |
  [**HBase**](https://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-hbase-dist_2.11/1.3.0/geomesa-hbase-dist_2.11-1.3.0-bin.tar.gz) |
  [**Cassandra**](https://repo.locationtech.org/content/repositories/geomesa-releases/org/locationtech/geomesa/geomesa-cassandra-dist_2.11/1.3.0/geomesa-cassandra-dist_2.11-1.3.0-bin.tar.gz) |
  [**Source**](https://github.com/locationtech/geomesa/archive/geomesa_2.11-1.3.0.tar.gz)

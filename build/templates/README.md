...
The project is built using Maven with Java ${jdk.version}. To build, run:
...
Toolchains plugin for Java ${jdk.release.version}. A compatible `toolchains.xml` can be generated using the following script:

...
import org.apache.avro.io.{BinaryDecoder, DecoderFactory, EncoderFactory, DirectBinaryEncoder}
...
import org.locationtech.geomesa.features.avro.{FeatureSpecificReader, AvroSimpleFeatureWriter}

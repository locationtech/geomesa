...
import org.locationtech.geomesa.utils.zk.ZookeeperMetadata.ZookeeperMetadataAdapter

class ZookeeperMetadata[T](val namespace: String, val zookeepers: String, val serializer: MetadataSerializer[T])
    extends CachedLazyMetadata[T] with ZookeeperMetadataAdapter

object ZookeeperMetadata {

  private val Root = "/"

  trait ZookeeperMetadataAdapter extends MetadataAdapter {
